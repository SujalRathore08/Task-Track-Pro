...
namespace TaskTrackPro.API.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        public ChatController(ChatService chatService, IConnectionMultiplexer redis, IHubContext<ChatHub> hubContext, ILogger<ChatController> logger)
        {
        ...
        public IActionResult GetOnlineUsers()
        {
            try
            {
                ...
                var onlineUsers = db.SetMembers("online_users").Select(x => x.ToString()).ToArray();
