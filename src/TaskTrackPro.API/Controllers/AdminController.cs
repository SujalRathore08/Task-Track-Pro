...
namespace TaskTrackPro.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(IAdminQuery adminQuery, ElasticsearchServices elasticssearchServices, IAdminCommand adminCommand, ITaskInterface taskInterface, ElasticsearchService elasticssearchService)  
        {
